...
export interface F1TechCarAsset extends ModelDefinition { version: string; scale: number; rotation: [number, number, number]; nodes: Partial<Record<CarComponentId, string>>; hotspots: F1TechHotspot[]; cameraPresets: Record<CameraPresetId, [number, number, number]>; materials?: Record<string, { label: string }>; beforeAsset?: string; afterAsset?: string; metadata: { author: string; license: ModelDefinition['license']; createdAt: string } }
...
export const carAssetRegistry: readonly F1TechCarAsset[] = [{
  id: 'bgrt-f1-concept-2026-evaluation', path: '/models/bgrt-f1-concept-2026.glb', license: 'User-provided local evaluation', version: 'evaluation', scale: 1.1, rotation: [0, 0, 0], nodes: {}, hotspots: [], attribution: 'BGRT-Studio; user-provided local evaluation asset', redistributable: false, editable: false,
  ...
  id: 'apex-formula-2026-evaluation', path: '/models/apex-formula-2026.glb', license: 'Apache-2.0', version: 'evaluation', scale: 1.15, rotation: [0, 0, 0], nodes: {}, hotspots: [], attribution: 'Apex Formula 2026 · Apache-2.0', redistributable: true, editable: true,
  cameraPresets: { default: [4.8, 2.75, 5.6], front: [0, 1.7, 6.9], rear: [0, 1.9, -6.9], side: [6.7, 2.15, 0], top: [0, 7.2, .35] },
