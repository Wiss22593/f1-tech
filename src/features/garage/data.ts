...
export const garageHotspots: F1TechHotspot[] = [
  ...
  { id: 'wheels', componentId: 'wheels', label: 'Wheels / Tyres', position: [-1.28, .58, -1.43], description: 'Mechanical' },
  { id: 'floor', componentId: 'floor', label: 'Floor', position: [-.85, .12, -.15], description: 'Aerodynamics' },
  { id: 'sidepods', componentId: 'sidepods', label: 'Sidepods', position: [1.06, .68, -.25], description: 'Aerodynamics' },
  { id: 'cooling', componentId: 'cooling', label: 'Cooling', position: [1.14, .72, -.38], description: 'Cooling' },
  { id: 'cockpit', componentId: 'chassis', label: 'Cockpit', position: [0, 1.02, .2], description: 'Body' },
  { id: 'halo', componentId: 'halo', label: 'Halo', position: [-.4, 1.12, .2], description: 'Safety' },
  { id: 'engineCover', componentId: 'engineCover', label: 'Engine Cover', position: [0, 1.38, -.92], description: 'Body' },
  { id: 'airbox', componentId: 'engineCover', label: 'Airbox', position: [0, 1.45, -.92], description: 'Cooling' },
  { id: 'rearSuspension', componentId: 'rearSuspension', label: 'Rear Suspension', position: [-1.0, .58, -1.35], description: 'Mechanical' },
  { id: 'rearBrake', componentId: 'rearBrake', label: 'Rear Brakes', position: [1.26, .5, -1.43], description: 'Mechanical' },
